...
.z-combobox-rounded-focus .z-combobox-rounded-readonly {
	background-image: url(${c:encodeURL('/img/component/g-combobox-rounded-s.gif')});
}
...
.z-bandbox-rounded-focus .z-bandbox-rounded-readonly {
	background-image: url(${c:encodeURL('/img/component/g-bandbox-rounded-s.gif')});
}
...
.z-datebox-rounded-focus .z-datebox-rounded-readonly {
	background-image: url(${c:encodeURL('/img/component/g-datebox-rounded-s.gif')});
}
...
.z-spinner-rounded-focus .z-spinner-rounded-readonly {
	background-image: url(${c:encodeURL('/img/component/g-timebox-rounded-s.gif')});
}