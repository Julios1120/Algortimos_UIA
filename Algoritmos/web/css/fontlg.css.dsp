...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeURL('/img/component/combobox-rounded-l.gif')});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeURL('/img/component/bandbox-rounded-l.gif')});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeURL('/img/component/datebox-rounded-l.gif')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp {
	background-image: url(${c:encodeURL('/img/component/timebox-rounded-l.gif')});
}
...
.z-spinner-rounded input.z-spinner-rounded-text-invalid {
	background: #FFF url(${c:encodeURL('/img/component/redcombo-rounded-l.gif')}) repeat-x 0 0;
}
